...
public class WalletTool {
    ...
    private static void rotate() throws BlockStoreException, OroSystemException {
        setup();
        peers.startAsync();
        peers.awaitRunning();
    ...
    private static void wait(WaitForEnum waitFor) throws BlockStoreException, OroSystemException {
    ...
    private static void setup() throws BlockStoreException, OroSystemException {
...
//            } else {
    ...
    private static void syncChain() {
        try {
            ...
            System.err.println("Error instantiating OroSystem: " + e.getMessage());
            e.printStackTrace();
        }
    }
    ...
    private static void dumpWallet() throws BlockStoreException, OroSystemException {
