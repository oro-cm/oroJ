...
public final class MonetaryFormat {
    ...
    /** Standard format for the ORO denomination. */
    public static final MonetaryFormat ORO = new MonetaryFormat().shift(0).minDecimals(2).repeatOptionalDecimals(2, 3);
    /** Standard format for the mORO denomination. */
    public static final MonetaryFormat MORO = new MonetaryFormat().shift(3).minDecimals(2).optionalDecimals(2);
    /** Standard format for the µORO denomination. */
    public static final MonetaryFormat UORO = new MonetaryFormat().shift(6).minDecimals(0).optionalDecimals(2);
    /** Standard format for fiat amounts. */
    public static final MonetaryFormat FIAT = new MonetaryFormat().shift(0).minDecimals(2).repeatOptionalDecimals(2, 1);
    /** Standard format for USD denominations. */
    public static final MonetaryFormat USD = FIAT;
    /** Currency code for base 1 Oro. */
    public static final String CODE_ORO = "ORO";
    /** Currency code for base 1/1000 Oro. */
    public static final String CODE_MORO = "mORO";
    /** Currency code for base 1/1000000 Oro. */
    public static final String CODE_UORO = "µORO";
    ...
    public MonetaryFormat() {
        ...
        this.codes.put(0, CODE_ORO);
        this.codes.put(3, CODE_MORO);
        this.codes.put(6, CODE_UORO);
        this.codeSeparator = ' ';
