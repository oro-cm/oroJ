 ...
 *
 * <ul>
 * <li>{@code oro:<address>}</li>
 * <li>{@code oro:<address>?<name1>=<value1>&<name2>=<value2>} with multiple
...
public class BitcoinURI {
    ...
    public static final String BITCOIN_SCHEME = "oro";
    ...
    public BitcoinURI(@Nullable NetworkParameters params, String input) throws BitcoinURIParseException {
        ...
        // blockchain.info generates URIs of non-BIP compliant form oro://address?....
        ...
        if (input.startsWith("oro://")) {
            schemeSpecificPart = input.substring("oro://".length());
        ...
        if (addressSplitTokens.length == 0)
            throw new BitcoinURIParseException("No data found after the oro: prefix");
    ...
    private void parseParameters(@Nullable NetworkParameters params, String addressToken, String[] nameValuePairTokens) throws BitcoinURIParseException {
        ...
        for (String nameValuePairToken : nameValuePairTokens) {
            ...
            if (sepIndex == -1)
                throw new BitcoinURIParseException("Malformed Oro URI - no separator in '" +
                        nameValuePairToken + "'");
            if (sepIndex == 0)
                throw new BitcoinURIParseException("Malformed Oro URI - empty name '" +
                        nameValuePairToken + "'");
    ...
    public String toString() {
        StringBuilder builder = new StringBuilder("OroURI[");
        boolean first = true;
