...
public class BtcFormatTest {
    ...
    public void parseTest() throws java.text.ParseException {
        ...
        assertEquals(valueOf(200000000), us.parseObject("2"));
        assertEquals(valueOf(200000000), usCoded.parseObject("ORO 2"));
    ...
    public void parseMetricTest() throws ParseException {
        ...
        // coin
        assertEquals(parseCoin("1"), cp.parseObject("ORO 1.00"));
        ...
        // megacoins
        assertEquals(parseCoin("1234567"), cp.parseObject("MORO 1.234567"));
    ...
    public void currencyCodeTest() {
        ...
        assertEquals("ORO 1.00", usCoded.format(COIN));
        ...
        assertEquals("1,00 ORO", frCoded.format(COIN));
        ...
        assertEquals("ORO 1,00", deCoded.format(COIN));
    }
    ...
    public void autoDecimalTest() {
        ...
        assertEquals("ORO 1", codedZero.format(COIN));
        ...
        assertEquals("ORO 1,000", codedZero.format(COIN.multiply(1000)));
        ...
        assertEquals("ORO 1.00", codedTwo.format(COIN));
        ...
        assertEquals("ORO 1,000.00", codedTwo.format(COIN.multiply(1000)));
        ...
        assertEquals("ORO 1.000", codedThree.format(COIN));
        ...
        assertEquals("ORO 1,000.000", codedThree.format(COIN.multiply(1000)));
    ...
    public void symbolsCodesTest() {
        ...
        BtcFixedFormat symbolCoin = (BtcFixedFormat)BtcFormat.builder().locale(US).scale(0).
                                                              symbol("B\u20e6").build();
        assertEquals("ORO", symbolCoin.code());
        ...
        BtcFixedFormat symbolMega = (BtcFixedFormat)BtcFormat.builder().locale(US).scale(-6).
                                                              symbol("B\u20e6").build();
        assertEquals("MORO", symbolMega.code());
    ...
    public void negativeTest() throws Exception {
        assertEquals("-1,00 ORO", BtcFormat.getInstance(FRANCE).format(COIN.multiply(-1)));
        assertEquals("ORO -1,00", BtcFormat.getInstance(ITALY).format(COIN.multiply(-1)));
        assertEquals("฿ -1,00", BtcFormat.getSymbolInstance(ITALY).format(COIN.multiply(-1)));
        assertEquals("ORO -1.00", BtcFormat.getInstance(JAPAN).format(COIN.multiply(-1)));
        assertEquals("฿-1.00", BtcFormat.getSymbolInstance(JAPAN).format(COIN.multiply(-1)));
        assertEquals("(ORO 1.00)", BtcFormat.getInstance(US).format(COIN.multiply(-1)));
        ...
        assertEquals("ORO -๑.๐๐", BtcFormat.getInstance(new Locale("th","TH","TH")).format(COIN.multiply(-1)));
    ...
    public void attributeTest() throws Exception {
        ...
        assertTrue(codePat.contains("ORO") && ! codePat.contains("(^|[^฿])฿([^฿]|$)") && ! codePat.contains("(^|[^¤])¤([^¤]|$)"));
        String symPat = BtcFormat.getSymbolInstance(Locale.US).pattern();
        assertTrue(symPat.contains("฿") && !symPat.contains("ORO") && !symPat.contains("¤¤"));

        assertEquals("ORO #,##0.00;(ORO #,##0.00)", BtcFormat.getCodeInstance(Locale.US).pattern());
    ...
    public void toStringTest() {
        ...
        assertEquals("Auto-format ORO #,##0.00;(ORO #,##0.00)", BtcFormat.getCodeInstance(Locale.US).toString());
        assertEquals("Auto-format ORO #,##0.0000;(ORO #,##0.0000)", BtcFormat.getCodeInstance(Locale.US, 4).toString());
    ...
    public void patternDecimalPlaces() {
        ...
        assertEquals("Millicoin-format ORO #.000;ORO -#.000", f.toString());
    ...
    public void builderTest() {
        ...
        assertEquals("ORO -1,00", built.format(COIN.multiply(-1)));
