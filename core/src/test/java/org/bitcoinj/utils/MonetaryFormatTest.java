...
public class MonetaryFormatTest {
    ...
    private static final MonetaryFormat NO_CODE = MonetaryFormat.ORO.noCode();
    ...
    public void standardCodes() throws Exception {
        assertEquals("ORO 0.00", MonetaryFormat.ORO.format(Coin.ZERO).toString());
        assertEquals("mORO 0.00", MonetaryFormat.MORO.format(Coin.ZERO).toString());
        assertEquals("µORO 0", MonetaryFormat.UORO.format(Coin.ZERO).toString());
    }

    @Test
    public void customCode() throws Exception {
        assertEquals("dORO 0", MonetaryFormat.UORO.code(1, "dORO").shift(1).format(Coin.ZERO).toString());
    }

    @Test
    public void codeOrientation() throws Exception {
        assertEquals("ORO 0.00", MonetaryFormat.ORO.prefixCode().format(Coin.ZERO).toString());
        assertEquals("0.00 ORO", MonetaryFormat.ORO.postfixCode().format(Coin.ZERO).toString());
    }

    @Test
    public void codeSeparator() throws Exception {
        assertEquals("ORO@0.00", MonetaryFormat.ORO.codeSeparator('@').format(Coin.ZERO).toString());
    }

    @Test(expected = NumberFormatException.class)
    public void missingCode() throws Exception {
        MonetaryFormat.UORO.shift(1).format(Coin.ZERO);
    }
    ...
    public void parse() throws Exception {
        ...
        assertEquals(Coin.MILLICOIN, MonetaryFormat.MORO.parse("1"));
        assertEquals(Coin.MILLICOIN, MonetaryFormat.MORO.parse("1.0"));
        assertEquals(Coin.MILLICOIN, MonetaryFormat.MORO.parse("01.0000000000"));
        assertEquals(Coin.MILLICOIN, MonetaryFormat.MORO.positiveSign('+').parse("+1.0"));
        assertEquals(Coin.MILLICOIN.negate(), MonetaryFormat.MORO.parse("-1"));
        assertEquals(Coin.MILLICOIN.negate(), MonetaryFormat.MORO.parse("-1.0"));

        assertEquals(Coin.MICROCOIN, MonetaryFormat.UORO.parse("1"));
        assertEquals(Coin.MICROCOIN, MonetaryFormat.UORO.parse("1.0"));
        assertEquals(Coin.MICROCOIN, MonetaryFormat.UORO.parse("01.0000000000"));
        assertEquals(Coin.MICROCOIN, MonetaryFormat.UORO.positiveSign('+').parse("+1.0"));
        assertEquals(Coin.MICROCOIN.negate(), MonetaryFormat.UORO.parse("-1"));
        assertEquals(Coin.MICROCOIN.negate(), MonetaryFormat.UORO.parse("-1.0"));
