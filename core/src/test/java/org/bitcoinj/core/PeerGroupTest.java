...
public class PeerGroupTest extends TestWithPeerGroup {
    ...
    public void preferLocalPeer() throws IOException {
        // Because we are using the same port (9777 or 19777) that is used by ORO client
        // We have to consider 2 cases:
        // 1. Test are executed on the same machine that is running full node / ORO client
        ...
        // Check that if we have a localhost port 9777 or 19777 then it's used instead of the p2p network.
