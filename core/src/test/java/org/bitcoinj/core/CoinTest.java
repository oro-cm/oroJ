...
public class CoinTest {
    ...
    public void testToFriendlyString() {
        assertEquals("1.00 ORO", COIN.toFriendlyString());
        assertEquals("1.23 ORO", valueOf(1, 23).toFriendlyString());
        assertEquals("0.001 ORO", COIN.divide(1000).toFriendlyString());
        assertEquals("-1.23 ORO", valueOf(1, 23).negate().toFriendlyString());
    }
